...
<head>
    ...
    <script type="text/javascript" src="forge/sha512.js"></script>
...
<body>
<div class="nav"><a href="index.html">Forge Tests</a> / Issue 428</div>
...
<div class="content">
    ...
    <fieldset class="section">
        <ul>
            ...
            <li>Behavior is that after a while a section of deterministic code starts to fail and stays failing. For
                instance, the SHA-1 hash of a constant input.
            </li>
            <li>Likely cause is a hot loop is getting improperly optimized. Opening the console causes code to function
                properly. Observing critical code via saving values or logging can cause code to function properly.
            </li>
            <li>PBKDF tests can fail due to use of the hashing functions.</li>
            <li><strong>Note</strong>: Due to the nature of this bug, once it is triggered a page refresh is required to
                test again.
            </li>
